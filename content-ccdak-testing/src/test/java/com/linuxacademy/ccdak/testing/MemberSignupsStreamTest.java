...
public class MemberSignupsStreamTest {
    ...
    public void test_first_name() {
        ...
        ConsumerRecord<byte[], byte[]> record = factory.create("member_signups", 1, "Jeferson, Igo");
        testDriver.pipeInput(record); //pipeInput just accept byte[] and ConsumerRecordFactory can help us in this conversion
        ...
        OutputVerifier.compareKeyValue(outputRecord, 1, "Igo");
    }
