...
public class MyConsumerTest {
    ...
    public void testHandleRecords_output(){
        ...
        HashMap<TopicPartition, Long> beginningsOffsets = new HashMap<>();
        beginningsOffsets.put(new TopicPartition(topic,0), 0L);
        mockConsumer.updateBeginningOffsets(beginningsOffsets);
